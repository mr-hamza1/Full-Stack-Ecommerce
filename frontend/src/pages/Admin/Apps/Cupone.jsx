...
const CouponGenerator = () => {
  ...
  const saveCoupon = () => {
            ...
            axios
          .post(`${import.meta.env.VITE_SERVER}/api/v1/payment/coupon/new?id=${user._id}`,  
            {
              code: generated,
              amount,
            },
  ...
  return (
     <AdminLayout menu={menu} setMenu={setMenu} >
      ...
      <Box mt={{xs: 15 , sm: 10}} width={"100%"} display="flex" flexDirection="column" alignItems="center" justifyContent="center">
