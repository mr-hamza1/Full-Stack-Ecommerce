...
export const cartReducer = createSlice({
    ...
    reducers: {
        ...
        discountApplied: (state, action)=>{
         ...
         filteringMinPrice: (state, action) => {
             state.minPrice = action.payload;
    },
         filteringMaxPrice: (state, action) => {
             state.maxPrice = action.payload;
    },
         mobileSearchWord: (state, action) => {
             state.mobileSearch = action.payload;
    },
         mobileCategoriesHome: (state, action) => {
...
export const { addToCart, removeCartItem, calculatePrice, discountApplied, mobileCategoriesHome,
    saveShippingInfo, resetCart, saveCoupon, filteringMinPrice, filteringMaxPrice,mobileSearchWord} = cartReducer.actions; 